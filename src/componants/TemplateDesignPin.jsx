    ...
    >
        ...
        <AnimatePresence>
           {isHovered && (
             ...
             {...FadeinOutOpacity} className='absolute inset-0 bg-[rgba(0,0,0,0.4)] flex flex-col items-center justify-start px-4 py-3 cursor-pointer'>
        ...
        >
           ...
           <AnimatePresence>
            {isHover && (
                ...
                className="px-3 py-2 rounded-md bg-gray-200 absolute -left-44 after:w-2 after:h-2 after:bg-gray-200 after:absolute after:-right-1 after:top-[14px] after:rotate">
