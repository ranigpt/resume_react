...
const handleclick = async ()=>{
    ...
    return (
        ...
        <div onClick ={handleclick}className="w-full px-4 py-3  rounded-md border-2 flex items-center justify-between cursor-pointer group hover:bg-purple-600 active:scale-95 hover:shadow-md">
